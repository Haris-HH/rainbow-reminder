...
/**
 * Animated delivery-truck loading indicator.
 * Adapted from uiverse.io/vinodjangid07 (MIT). Styles live in index.css,
 * namespaced under `.truck-loader` so the generic class names don't collide.
 */
